...
public class Video extends BaseEntity {
    ...
    public void setTitle(String title) {
        if (title == null) throw new IllegalArgumentException("title is marked not null but is null");
        if (title.length() == 0) throw new IllegalArgumentException("title is marked not blank but is blank");
        this.title = title;
    }
    ...
    public void setVideoFiles(List<VideoFile> files) {
        if (files == null) throw new IllegalArgumentException("files is marked not null but is null");
